...
import com.learning.graphql_crud_application.models.response.GenericResponse;
...
public class CustomerClient {
    ...
    public Mono<CustomerResponse> getCustomerByIdWithUnion(Integer id) {
        return this.client
                ...
                .map(cr -> {
                    var field = cr.field("customerById");
                    var isCustomer = "Customer".equals(Objects.requireNonNull(cr.field("customerById.type").getValue()).toString());
